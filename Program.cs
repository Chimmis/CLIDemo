    ...
    class Program
    {
        public static async Task<int> Main(string[] args)
        {
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine("Run demo -h or demo <command name> -h to receive information about the command");
        ...
        {
            private readonly string ConfigurationPath = Environment.GetEnvironmentVariable("USERPROFILE") + $"{Path.DirectorySeparatorChar}demoOptions.json";
